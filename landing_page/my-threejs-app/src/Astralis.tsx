...
//  * - Illuminated text with letter-by-letter animation
//  * - Growing and fading central sphere
//  * - Translucent card appearing after sphere disappears
//  */
// const Astralis: React.FC = () => {
//   // Reference to the container div for Three.js canvas
//   const containerRef = useRef<HTMLDivElement>(null);
...
//   // State to track if the card should be shown
...
//     const animationDuration = 1.5;    // Duration of animation (seconds)
//     let sphereVisible = true;         // Visibility state of sphere
//     let cardAnimationTriggered = false; // Flag to track if card animation has been triggered
...
//           // Trigger card animation if not already triggered
//           if (!cardAnimationTriggered) {
//             cardAnimationTriggered = true;
...
//     // Style for the card that appears after sphere animation
//     card: {
//       position: 'absolute' as 'absolute',
//       width: '320px', 
//       height: '240px',
//       backgroundColor: 'rgba(26, 35, 126, 0.3)', // Same blue as sphere but translucent
...
//       alignItems: 'center',
//       padding: '20px',
//       boxShadow: '0 0 20px rgba(74, 108, 247, 0.2)',
//       backdropFilter: 'blur(5px)',
//       opacity: 0,
//       transform: 'scale(0.8)',
//       transition: 'opacity 1.2s ease, transform 1.2s ease' // Slower transition for smoother fade
//     }
//   };
...
//       {/* UI Elements overlay */}
//       <div style={styles.uiContainer}>
//         {/* Card that appears after sphere animation - now empty */}
//         {showCard && (
//           <div 
//             style={{
//               ...styles.card,
...
//             }}
//           >
//             {/* Card content removed to prevent duplication */}
//           </div>
//         )}
